...
<html lang="en" data-bs-theme="auto">
  <head><script src="{{ secure_asset('assets/js/color-modes.js') }}"></script>
    ...
    <!-- Custom styles for this template -->
    <link href="{{ secure_asset('backend/dashboard.css') }}" rel="stylesheet">
  </head>
  <body>
...
<div class="container-fluid">
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" style="height: 100vh" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Tes Konco Studio</h5>
